...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("count-to-eleven", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("count-to-eleven", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "27";
		app.meta["company"] = "Woofle";
		app.meta["file"] = "count-to-eleven";
		app.meta["name"] = "Count To Eleven";
