...
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_50_urlEncode,"StringTools","urlEncode",0x06afdce1,"StringTools.urlEncode","D:\\HAXE\\haxe\\std/StringTools.hx",50,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_118_urlDecode,"StringTools","urlDecode",0x71b947f9,"StringTools.urlDecode","D:\\HAXE\\haxe\\std/StringTools.hx",118,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_158_htmlEscape,"StringTools","htmlEscape",0x0e1a5dd0,"StringTools.htmlEscape","D:\\HAXE\\haxe\\std/StringTools.hx",158,0xee8ca626)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_194_htmlUnescape,"StringTools","htmlUnescape",0x7457fea9,"StringTools.htmlUnescape","D:\\HAXE\\haxe\\std/StringTools.hx",194,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_238_startsWith,"StringTools","startsWith",0x5f4e6efb,"StringTools.startsWith","D:\\HAXE\\haxe\\std/StringTools.hx",238,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_249_endsWith,"StringTools","endsWith",0x0eb5bfe2,"StringTools.endsWith","D:\\HAXE\\haxe\\std/StringTools.hx",249,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_278_isSpace,"StringTools","isSpace",0xe0290778,"StringTools.isSpace","D:\\HAXE\\haxe\\std/StringTools.hx",278,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_296_ltrim,"StringTools","ltrim",0x24d2234a,"StringTools.ltrim","D:\\HAXE\\haxe\\std/StringTools.hx",296,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_321_rtrim,"StringTools","rtrim",0x99399e50,"StringTools.rtrim","D:\\HAXE\\haxe\\std/StringTools.hx",321,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_349_trim,"StringTools","trim",0x2908d066,"StringTools.trim","D:\\HAXE\\haxe\\std/StringTools.hx",349,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_365_lpad,"StringTools","lpad",0x23bd8feb,"StringTools.lpad","D:\\HAXE\\haxe\\std/StringTools.hx",365,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_424_replace,"StringTools","replace",0x6d651f30,"StringTools.replace","D:\\HAXE\\haxe\\std/StringTools.hx",424,0xee8ca626)
HX_LOCAL_STACK_FRAME(_hx_pos_fee452954c052994_434_hex,"StringTools","hex",0xd91debd7,"StringTools.hex","D:\\HAXE\\haxe\\std/StringTools.hx",434,0xee8ca626)
...
::String StringTools_obj::urlEncode(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_50_urlEncode)
...
::String StringTools_obj::urlDecode(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_118_urlDecode)
...
::String StringTools_obj::htmlEscape(::String s, ::Dynamic quotes){
            	HX_GC_STACKFRAME(&_hx_pos_fee452954c052994_158_htmlEscape)
...
::String StringTools_obj::htmlUnescape(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_194_htmlUnescape)
...
bool StringTools_obj::startsWith(::String s,::String start){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_238_startsWith)
...
bool StringTools_obj::endsWith(::String s,::String end){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_249_endsWith)
...
bool StringTools_obj::isSpace(::String s,int pos){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_278_isSpace)
...
::String StringTools_obj::ltrim(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_296_ltrim)
...
::String StringTools_obj::rtrim(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_321_rtrim)
...
::String StringTools_obj::trim(::String s){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_349_trim)
...
::String StringTools_obj::lpad(::String s,::String c,int l){
            	HX_GC_STACKFRAME(&_hx_pos_fee452954c052994_365_lpad)
...
::String StringTools_obj::replace(::String s,::String sub,::String by){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_424_replace)
...
::String StringTools_obj::hex(int n, ::Dynamic digits){
            	HX_STACKFRAME(&_hx_pos_fee452954c052994_434_hex)
