...
HX_DEFINE_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_26_new,"Date","new",0x9aa26240,"Date.new","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",26,0x6a56a343)
HX_LOCAL_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",30,0x6a56a343)
HX_LOCAL_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_94_toString,"Date","toString",0xd2a372cc,"Date.toString","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",94,0x6a56a343)
HX_LOCAL_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_98_now,"Date","now",0x9aa26af6,"Date.now","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",98,0x6a56a343)
HX_LOCAL_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",105,0x6a56a343)
HX_LOCAL_STACK_FRAME(_hx_pos_a97b0e5cea608dc6_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","D:\\HAXE\\haxe\\std/cpp/_std/Date.hx",112,0x6a56a343)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_30_getTime)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_98_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_a97b0e5cea608dc6_112_fromString)
