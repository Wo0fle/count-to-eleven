...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("count-to-eleven",95,86,87,df),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Woofle",88,3b,33,fc));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("count-to-eleven",95,86,87,df));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Count To Eleven",55,c4,1b,36));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Count To Eleven",55,c4,1b,36))
