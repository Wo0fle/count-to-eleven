...
HX_LOCAL_STACK_FRAME(_hx_pos_512debbbf6b56c3f_167_charCodeAt,"_UnicodeString.UnicodeString_Impl_","charCodeAt",0xd9768435,"_UnicodeString.UnicodeString_Impl_.charCodeAt","D:\\HAXE\\haxe\\std/UnicodeString.hx",167,0x1fdcdae2)
HX_LOCAL_STACK_FRAME(_hx_pos_512debbbf6b56c3f_315_substr,"_UnicodeString.UnicodeString_Impl_","substr",0xd1a740f0,"_UnicodeString.UnicodeString_Impl_.substr","D:\\HAXE\\haxe\\std/UnicodeString.hx",315,0x1fdcdae2)
HX_LOCAL_STACK_FRAME(_hx_pos_512debbbf6b56c3f_415_get_length,"_UnicodeString.UnicodeString_Impl_","get_length",0x33b0a1ee,"_UnicodeString.UnicodeString_Impl_.get_length","D:\\HAXE\\haxe\\std/UnicodeString.hx",415,0x1fdcdae2)
...
bool UnicodeString_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic UnicodeString_Impl__obj::charCodeAt(::String this1,int index){
            	HX_STACKFRAME(&_hx_pos_512debbbf6b56c3f_167_charCodeAt)
...
::String UnicodeString_Impl__obj::substr(::String this1,int pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_512debbbf6b56c3f_315_substr)
HXLINE( 316)		if ((pos < 0)) {
...
int UnicodeString_Impl__obj::get_length(::String this1){
            	HX_STACKFRAME(&_hx_pos_512debbbf6b56c3f_415_get_length)
HXLINE( 416)		int l = 0;
HXLINE( 417)		{
