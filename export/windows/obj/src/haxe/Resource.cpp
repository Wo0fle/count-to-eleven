...
HX_LOCAL_STACK_FRAME(_hx_pos_ecc693a77080f953_35_getBytes,"haxe.Resource","getBytes",0x9bc1712d,"haxe.Resource.getBytes","D:\\HAXE\\haxe\\std/cpp/_std/haxe/Resource.hx",35,0xb8320f74)
namespace haxe{
...
bool Resource_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes Resource_obj::getBytes(::String name){
            	HX_STACKFRAME(&_hx_pos_ecc693a77080f953_35_getBytes)
