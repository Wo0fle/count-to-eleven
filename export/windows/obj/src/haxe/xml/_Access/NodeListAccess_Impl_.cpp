...
HX_LOCAL_STACK_FRAME(_hx_pos_f201d465dd1a8ff6_75_resolve,"haxe.xml._Access.NodeListAccess_Impl_","resolve",0x07a0eeac,"haxe.xml._Access.NodeListAccess_Impl_.resolve","D:\\HAXE\\haxe\\std/haxe/xml/Access.hx",75,0x0d4918ab)
namespace haxe{
namespace xml{
namespace _Access{
...
::Array< ::Dynamic> NodeListAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_f201d465dd1a8ff6_75_resolve)
