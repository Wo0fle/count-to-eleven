...
HX_DEFINE_STACK_FRAME(_hx_pos_edaee94a3b0f124e_75_new,"haxe.xml.XmlParserException","new",0xcd6fdfea,"haxe.xml.XmlParserException.new","D:\\HAXE\\haxe\\std/haxe/xml/Parser.hx",75,0xef850850)
HX_LOCAL_STACK_FRAME(_hx_pos_edaee94a3b0f124e_95_toString,"haxe.xml.XmlParserException","toString",0xed7c2ce2,"haxe.xml.XmlParserException.toString","D:\\HAXE\\haxe\\std/haxe/xml/Parser.hx",95,0xef850850)
namespace haxe{
namespace xml{

void XmlParserException_obj::__construct(::String message,::String xml,int position){
            	HX_STACKFRAME(&_hx_pos_edaee94a3b0f124e_75_new)
...
::String XmlParserException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_edaee94a3b0f124e_95_toString)
