...
HX_DEFINE_STACK_FRAME(_hx_pos_cd50adbb0011dbc6_252_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","D:\\HAXE\\haxe\\std/haxe/ds/BalancedTree.hx",252,0x68f9780f)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,::hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_cd50adbb0011dbc6_252_new)
