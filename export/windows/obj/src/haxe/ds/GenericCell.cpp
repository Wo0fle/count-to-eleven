...
HX_DEFINE_STACK_FRAME(_hx_pos_c64cb2ccf6619963_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","D:\\HAXE\\haxe\\std/haxe/ds/GenericStack.hx",37,0x45db8084)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_c64cb2ccf6619963_37_new)
