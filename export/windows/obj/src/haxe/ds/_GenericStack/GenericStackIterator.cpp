...
HX_DEFINE_STACK_FRAME(_hx_pos_056ff0f2ab0e816c_78_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","D:\\HAXE\\haxe\\std/haxe/ds/GenericStack.hx",78,0x45db8084)
HX_LOCAL_STACK_FRAME(_hx_pos_056ff0f2ab0e816c_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","D:\\HAXE\\haxe\\std/haxe/ds/GenericStack.hx",68,0x45db8084)
HX_LOCAL_STACK_FRAME(_hx_pos_056ff0f2ab0e816c_71_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","D:\\HAXE\\haxe\\std/haxe/ds/GenericStack.hx",71,0x45db8084)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_STACKFRAME(&_hx_pos_056ff0f2ab0e816c_78_new)
...
bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_056ff0f2ab0e816c_68_hasNext)
HXDLIN(  68)		return ::hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_056ff0f2ab0e816c_71_next)
