...
HX_DEFINE_STACK_FRAME(_hx_pos_6014ae31bd162047_30_new,"sys.thread.Lock","new",0x586e3f40,"sys.thread.Lock.new","D:\\HAXE\\haxe\\std/cpp/_std/sys/thread/Lock.hx",30,0x81355edd)
HX_LOCAL_STACK_FRAME(_hx_pos_6014ae31bd162047_34_wait,"sys.thread.Lock","wait",0x0df8ef95,"sys.thread.Lock.wait","D:\\HAXE\\haxe\\std/cpp/_std/sys/thread/Lock.hx",34,0x81355edd)
namespace sys{
namespace thread{

void Lock_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6014ae31bd162047_30_new)
...
bool Lock_obj::wait( ::Dynamic __o_timeout){
            	...
            	HX_STACKFRAME(&_hx_pos_6014ae31bd162047_34_wait)
