...
HX_DEFINE_STACK_FRAME(_hx_pos_5c365bb86276a83c_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","D:\\HAXE\\haxe\\std/sys/thread/NoEventLoopException.hx",7,0x75cefe7b)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_5c365bb86276a83c_7_new)
