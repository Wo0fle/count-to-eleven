...
HX_LOCAL_STACK_FRAME(_hx_pos_cc4c253c4e06b6fd_34__loadPrime,"cpp.Prime","_loadPrime",0xdd360794,"cpp.Prime._loadPrime","D:\\HAXE\\haxe\\std/cpp/Prime.hx",34,0x92f99abd)
namespace cpp{
...
bool Prime_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Prime_obj::_loadPrime(::String lib,::String prim,::String signature,::hx::Null< bool >  __o_quietFail){
            	...
            	HX_STACKFRAME(&_hx_pos_cc4c253c4e06b6fd_34__loadPrime)
